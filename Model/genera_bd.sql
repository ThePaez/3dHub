...
-- -----------------------------------------------------
-- Table `COMPRAVENTA`.`CARRITO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `COMPRAVENTA`.`CARRITO` ;

CREATE  TABLE IF NOT EXISTS `COMPRAVENTA`.`CARRITO` (
...
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_spanish_ci
COMMENT = 'Mantiene el registro de los carritos de compra correspondien';
...
-- -----------------------------------------------------
-- Table `COMPRAVENTA`.`CARRITO_X_PRODUCTO`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `COMPRAVENTA`.`CARRITO_X_PRODUCTO` ;

CREATE  TABLE IF NOT EXISTS `COMPRAVENTA`.`CARRITO_X_PRODUCTO` (
  `ID_CARRITO` INT NOT NULL ,
  `ID_PRODUCTO` INT NOT NULL ,
  `CANTIDAD` INT NOT NULL ,
  INDEX `fk_CARRITO_X_PRODUCTO_CARRITO1` (`ID_CARRITO` ASC) ,
  PRIMARY KEY (`ID_CARRITO`, `ID_PRODUCTO`) ,
  INDEX `fk_CARRITO_X_PRODUCTO_PRODUCTO1` (`ID_PRODUCTO` ASC) ,
  CONSTRAINT `fk_CARRITO_X_PRODUCTO_CARRITO1`
    FOREIGN KEY (`ID_CARRITO` )
    REFERENCES `COMPRAVENTA`.`CARRITO` (`ID_CARRITO` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
